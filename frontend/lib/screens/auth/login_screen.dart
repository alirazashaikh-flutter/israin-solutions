                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text('OR CONTINUE WITH', style: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.w500, color: Colors.white.withValues(alpha: 0.4), letterSpacing: 0.05)),
                              ),
                              Expanded(child: Divider(color: Colors.white.withValues(alpha: 0.15))),
                            ],
                          ),
                            ...
                            children: [
                              Expanded(
                                child: OutlinedButton.icon(
                                  ...
                                  style: OutlinedButton.styleFrom(foregroundColor: Colors.white, side: BorderSide(color: Colors.white.withValues(alpha: 0.15)), padding: const EdgeInsets.symmetric(vertical: 14), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
                                ),
                              ),
